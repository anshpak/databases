...
#---------------------------------------------------
# Убрать auto_increment у primary key столбца.
#---------------------------------------------------
...
modify student_id tinyint unsigned;

insert into students_info
(student_id, student_name, student_surname, student_subgroup, grade_point_average, monthly_scholarship, tution_fee, student_sex, participation, student_birth_date, has_student_debths, student_home_city)
values
(11, 'Михаил', 'Смирнов', 'a', 8.6, 220, default, 'male', default, '2004-06-11', false, 'Minsk'),
(14, 'Адам', 'Федоров', 'a', 5.2, 0, 1600, 'male', default, '2003-09-05', true, 'Borysov'),
(17, 'Ирина', 'Иванова', 'b', 6.4, 160, default, 'female', 'Student Council,BRYU', '2005-12-17', false, 'Minsk'),
(18, 'Роман', 'Черный', 'b', 10, 240, default, 'male', default, '2004-01-26', false, 'Mogilev'),
(19, 'Арина', 'Волкова', 'a', 9.3, 0, 1400, 'female', 'Council of Elders', '2005-05-21', false, 'Lida'),
(22, 'Артур', 'Кожевников', 'b', 7.7, 180, default, 'male', 'Student Council of Quality of Education,Council of Dormitries,BRYU', '2004-07-31', false, 'Slonim'),
(26, 'Игорь', 'Морохов', 'a', 8.4, 220, default, 'male', default, '2004-10-16', false, 'Dzerzinsk');
select * from students_info;